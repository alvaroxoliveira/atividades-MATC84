...
class DesafiosJsonXml(unittest.TestCase):
	...
	def reposta_1(self):
		return '{ "nome": "Fred", "cargo": "Professor de Laboratorio Web" }'
	...
	#Um objeto com tag professor, e um atributo chamado nome com valor "Fred" e um atributo chamado cargo com valor "Professor de Lab Web"
	def reposta_2(self):
		return "\
<?xml version=\"1.0\"?>\
<dados>\
...
"
	...
	#Desafio 3
	#Dona Neya Matofino é uma senhora que sofre de Síndrome Jsônica, uma doença onde ela só consegue ler JSON.
	#Ela não sabe mexer em computadores, e pediu que você ajude ela a escrever a lista de compras dela.
	...
	#Desafio 4
	#Seu primo Max Verstappen adora carros, e quando soube que você faz computação na UFBA, não se aguentou e pediu sua ajuda.
	#Ele quer que você crie um XML cujos dados contenham 2 objetos com tag carro.
	#O primeiro deve ter nome "Golf", e um atributo chamado fabricante, com nome "Volkswagen" e origem "Alemanha"
	#O segundo deve ter nome "Uno Mille", e um atributo chamado fabricante, com nome "Fiat" e origem "Itália"
	def reposta_4(self):
		return "\
<?xml version=\"1.0\"?>\
<dados>\
...
"
	...
	#Desafio 5
	#Tony Soprano é um pizzaiolo muito ocupado, e te contratou para ajudá-lo a usar o mais novo app de entregas, o iShoot.
